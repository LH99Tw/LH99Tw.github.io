---
title: "AI"
description: "생성형 AI, 모델 실험, 프롬프트 엔지니어링 등 AI 학습 기록을 정리합니다."
layout: default
category: ai
category_board: true
hide_topbar: true
...
{% assign board_posts = site.posts | where_exp: "post", "post.categories contains 'ai'" | sort: 'date' | reverse %}
      ...
      {% if board_posts.size > 0 %}
        {% for post in board_posts %}
          <a class="post-item" href="{{ post.url | relative_url }}">
            <span class="post-item__cat">AI</span>
